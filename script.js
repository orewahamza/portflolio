...
function initSimpleForm() {
    ...
    if (keyInput) {
        keyInput.value = (window.config && window.config.WEB3FORMS_ACCESS_KEY) || "a6cdd593-43e0-417a-a1ba-aa3d4bc87dc0";
    }
            ...
            if (emailStep === 1) {
                ...
                try {
                    const response = await fetch("https://api.web3forms.com/submit", {
                        ...
                        body: JSON.stringify({
                            access_key: (window.config && window.config.WEB3FORMS_ACCESS_KEY) || "a6cdd593-43e0-417a-a1ba-aa3d4bc87dc0", // Web3Forms Access Key
                            name: "Terminal User",
                            email: tempEmail,
                            message: cleanCmd,
